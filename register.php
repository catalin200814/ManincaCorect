...
<div class="auth-page">
  <div class="auth-card">
    <div class="auth-header">
      ...
      <p>Înregistrează-te gratuit pe PlanMeal</p>
    </div>
    <?php if ($error): ?>
      <div class="alert alert-error"><?= htmlspecialchars($error) ?></div>
    <?php endif; ?>
    <?php if ($success): ?>
      <div class="alert alert-success"><?= htmlspecialchars($success) ?> <a href="login.php">Conectează-te aici</a></div>
    <?php endif; ?>
    <form method="POST" action="register.php" class="auth-form">
      <div class="form-group">
        <label for="nume">Nume complet</label>
        <input type="text" id="nume" name="nume" placeholder="Numele tău" value="<?= htmlspecialchars($_POST['nume'] ?? '') ?>" required>
      </div>
      <div class="form-group">
      ...
      <button type="submit" class="btn-primary btn-full">Înregistrează-te</button>
    </form>
    <div class="auth-footer">Ai deja cont? <a href="login.php">Conectează-te</a></div>
  </div>
</div>
